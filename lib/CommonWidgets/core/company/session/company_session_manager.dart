...
import '../../../../LoginPages/credetials/services/auth_service.dart';
...
class CompanySessionManager {
  ...
  /// Calls the systray attendance endpoint with location coordinates.
  /// Used for check-in and check-out attendance actions.
  /// Executes the request using the active authenticated session.
