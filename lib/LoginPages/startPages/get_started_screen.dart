  ...
  late final List<Map<String, String>> onboardingData = [
    {
      ...
      'title': 'Manage Your Attendance',
      'description':
      'Easily track your daily clock-ins, clock-outs, and working hours.',
    },
    {
      'image': _getImagePath('2'),
      'title': 'Request and Track Leave',
      'description':
      'Submit leave requests, check approvals, and monitor leave balances in real-time.',
    },
    {
      'image': _getImagePath('3'),
      'title': 'Monitor Work Hours',
      'description':
      'Get insights on your attendance patterns and ensure accurate reporting every day.',
    },
  ];
