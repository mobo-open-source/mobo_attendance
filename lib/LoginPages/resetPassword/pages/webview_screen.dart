...
/// A screen that displays a web page using WebView.
///
/// Supports:
...
/// Manages WebView loading, navigation, refresh, and error handling.
class _WebViewScreenState extends State<WebViewScreen> {
  ...
  /// Initializes WebView controller and navigation callbacks.
  ...
  /// If no history, closes the screen.
  void _goBack() async {
  ...
  /// Returns false if WebView goes back, true to exit screen.
  ...
  /// Builds error UI when page fails to load.
